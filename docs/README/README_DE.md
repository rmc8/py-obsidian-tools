...
# Mit pip-Installation
pyobsidian-index <Befehl>
```

| Befehl | Beschreibung |
|--------|--------------|
| `full` | Alle Notizen im Vault indizieren |
| `update` | Inkrementelles Update (nur neue/geänderte Notizen) |
| `clear` | Gesamten Index löschen |
| `status` | Index-Status anzeigen |
