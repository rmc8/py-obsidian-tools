...
- "Dataview क्वेरी चलाएं और #project टैग वाले सभी नोट्स की सूची दें"
- "आज का दैनिक नोट प्राप्त करें"
- "सक्रिय नोट के 'Tasks' सेक्शन को अपडेट करें"
- "Obsidian API सर्वर की स्थिति जांचें"
...
| कमांड | विवरण |
|-------|-------|
| `full` | वॉल्ट के सभी नोट्स को इंडेक्स करें |
| `update` | इंक्रीमेंटल अपडेट (केवल नए/संशोधित नोट्स) |
| `clear` | पूरा इंडेक्स साफ़ करें |
| `status` | इंडेक्स स्थिति दिखाएं |
